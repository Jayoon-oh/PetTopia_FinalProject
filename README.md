# 📝 개요
  - 프로젝트 명 : 펫토피아<br>
  - 프로젝트 기간 : 2024-12-23 ~ 2025-2-7<br>
...
# 🗂️ 주요 기능
이 사이트는 반려동물 호텔 그룹웨어입니다. <br>
사용자는 기본적인 그룹웨어 기능인 전자결재, 일정관리, 게시글 관리, 쪽지 기능 외에
객실 및 서비스관리 등을 더하여 호텔 체인 운영이 가능합니다.<br>
더불어 메인화면의 대시보드 기능으로 근태기록, 객실 점유율 확인, 결재선 알림 등을 이용하여 보다 빠르고 효율적으로 개인 편의사항들을 이용할 수 있습니다.
